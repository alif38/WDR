...
<nav id='cssmenu'>
    <div class="logo"><a href="../index.php">World Data Review </a></div>
    ...
    <ul id="">
            ...
            <ul>
                <li><a href='#'>By Topic</a>
                    <ul>
                        ...
                        <li><a href='#'>National Defense</a></li>
                ...
                <li><a href='#'>By Local Government </a>
                    <ul>
                        <li><a href='#'>Ministry of Establishment </a></li>
                        <li><a href='#'>Ministry of Finance </a></li>
                        <li><a href='#'>Ministry of Law, Justice & Parliamentary Affairs</a></li>
                        <li><a href='#'>Ministry of Agriculture</a></li>
                        <li><a href='#'>Ministry of Food and Disaster Management</a></li>
                        <li><a href='#'>Ministry of Post and Tele-communication</a></li>
                        <li><a href='#'>Ministry of Information</a></li>
                        <li><a href='#'>Ministry of Religious Affairs </a></li>
                        <li><a href='#'>Ministry of Environment and Forest</a></li>
                        <li><a href='#'>Ministry of Defense</a></li>
                        <li><a href='#'>Ministry of Labour and Employment</a></li>
                        <li><a href='#'>Ministry of Housing and Public Works</a></li>
                        <li><a href='#'>Ministry of Commerce</a></li>
                        <li><a href='#'>Ministry of Power, Energy and Mineral Resources</a></li>
                        <li><a href='#'>Ministry of Civil Aviation and Tourism</a></li>
                        <li><a href='#'>Ministry of Land</a></li>
                        <li><a href='#'>Ministry of Fisheries and Livestock</a></li>
                        <li><a href='#'>Ministry of Communications</a></li>
                        <li><a href='#'>Ministry of Industries</a></li>
                        <li><a href='#'>Ministry of Education</a></li>
                        <li><a href='#'>Ministry of Primary and Mass Education</a></li>
                        <li><a href='#'>Ministry of Science and Information & Communication Technology</a></li>
                        <li><a href='#'>Ministry of Water Resources</a></li>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href='#'>Data Philanthophy   </a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href='#'>Editors    </a>
                    <ul>
                        <li><a href='../about.php#chief'>Editor in Chief </a></li>
                        <li><a href='#'>Assistant Editors </a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if(current.search('about') > 0){
            $("[href='about.php']").addClass('active')
        } else if(current.search('index') > 0){
